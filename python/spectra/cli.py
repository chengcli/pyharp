...
def build_parser() -> argparse.ArgumentParser:
    ...
    spectrum.add_argument("--output", type=Path, default=None)
    spectrum.add_argument("--figure", type=Path, default=None)
    ...
    transmittance.add_argument("--output", type=Path, default=None)
    transmittance.add_argument("--figure", type=Path, default=None)
...
def main() -> None:
    ...
    if args.command == "spectrum":
        ...
        figure_path = args.figure or _default_cli_output_path(args, suffix=".png")

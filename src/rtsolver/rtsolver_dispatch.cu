...
void call_toon89_lw_cuda(at::TensorIterator& iter, int rank_in_column,
...
REGISTER_CUDA_DISPATCH(call_toon89_lw, &disort::call_toon89_lw_cuda);
REGISTER_CUDA_DISPATCH(call_toon89_sw, &disort::call_toon89_sw_cuda);

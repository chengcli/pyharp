...
int main(int argc, char **argv) {
  ...
  std::ifstream file("/home/cometz/pyharp/examples/aerosol_output_data.txt");
  ...
  // Extract pressure and mixing ratios
  ...
  for (int i = 0; i < nwave; ++i) {
    for (int k = 0; k <= nlyr; ++k) {
      integrated_flux[k][0] += result[i][0][k][0].item<double>() * d_lambda;  //(x,x,x,0) is up
